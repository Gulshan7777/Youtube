    ...
    return (
        <Link to={`/video/${video.videoId}`}>
            <div className="flex mb-3">
                <div className="relative h-30 lg:h-24 w-40 min-w-[168px] lg:w-32 lg:min-w-[128px] xl:w-40 xl:min-w-[168px] rounded-xl bg-slate-800 overflow-hidden">
                ...
                <div className="flex flex-col ml-3 overflow-hidden">
                    ...
                    <div className="flex text-[12px] lg:text-[10px] xl:text-[12px]  font-semibold text-white/[0.7] truncate overflow-hidden">
                        <span>{video?.stats?.views && `${abbreviateNumber(video?.stats?.views, 2)} views`}</span>
